...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" description="" name="SDE Feature Class" format="" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" type="ArcSDE Connection" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
